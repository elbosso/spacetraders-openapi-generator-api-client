 ...
 */
@JsonPropertyOrder({
  ShipRefineRequest.JSON_PROPERTY_PRODUCE
})
@JsonTypeName("ship_refine_request")
...
public class ShipRefineRequest {
  ...
  public static final String JSON_PROPERTY_PRODUCE = "produce";
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_PRODUCE)
