 ...
 */
@JsonPropertyOrder({
  DeliverContract200ResponseData.JSON_PROPERTY_CONTRACT,
  DeliverContract200ResponseData.JSON_PROPERTY_CARGO
})
@JsonTypeName("deliver_contract_200_response_data")
