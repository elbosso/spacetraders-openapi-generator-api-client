 ...
 */
@JsonPropertyOrder({
  ExtractionYield.JSON_PROPERTY_SYMBOL,
  ExtractionYield.JSON_PROPERTY_UNITS
})
...
public class ExtractionYield {
  ...
  public ExtractionYield symbol(String symbol) {
  ...
  **/
  ...
  public ExtractionYield units(Integer units) {
