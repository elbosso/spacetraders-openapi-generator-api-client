 ...
 */
@JsonPropertyOrder({
  CreateShipWaypointScan201ResponseData.JSON_PROPERTY_COOLDOWN,
  CreateShipWaypointScan201ResponseData.JSON_PROPERTY_WAYPOINTS
})
@JsonTypeName("create_ship_waypoint_scan_201_response_data")
